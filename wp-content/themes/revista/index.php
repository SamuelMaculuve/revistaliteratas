...
?>
  ...
  <div class="block-31" style="position: relative;">
    <div class="owl-carousel loop-block-31 ">
      <div class="block-30 block-30-sm item" style="background-image: url('<?php bloginfo('template_url'); ?>/assets/images/Foto_de_Capa.jpg');" data-stellar-background-ratio="0.5">
        <div class="container">
        ...
        <div class="col-md-6">
          <div class="media block-6">
            ...
            <div class="media-body">
              ...
              <p>Realizar pesquisas e extensão académica, orientadas a solução dos problemas socioeconómicos que assolam a sociedade e promoção do conhecimento tecnocientífico para servir o desenvolvimento.
</p>
            </div>
          </div>     
        </div>
        ...
        <div class="col-md-6">
          <div class="media block-6">
            ...
            <div class="media-body">
              ...
              <p>Construir uma sociedade que se serve do conhecimento tecnocientífico produzido e difundido para desenvolver-se de forma sustentável.
...
.</p>
  ...
  <div class="bg-image overlay site-section" style="background-image: url('');">
      <div class="container">
            ...
            <div class="row mb-5">
              <div class="col-md-7">
                <div class="heading-20219">
                  <h2 class="title text-black mb-4 text-cursive">Princípios da AMEA</h2>
  ...
  <div class="featured-donate overlay-color" style="background-image: url('<?php bloginfo('template_url'); ?>/assets/images/bg_2.jpg');">
    
    <div class="container">
      <div class="row">
        <div class="col-lg-8 order-lg-2 mb-3 mb-lg-0">
          <img src="<?php bloginfo('template_url'); ?>/assets/images/bg_2.jpg" alt="Image placeholder" class="img-fluid">
        </div>
        <div class="col-lg-4 pr-lg-5">
          ...
          <span class="donation-time mb-3">Last donation 1w ago</span>
        ...
        <div class="col-md-12 block-11">
          <div class="nonloop-block-11 owl-carousel">
            ...
            <div class="card fundraise-item">
              <a href="#"><img class="card-img-top" src="<?php bloginfo('template_url'); ?>/assets/images/img_1.jpg" alt="Image placeholder"></a>
              <div class="card-body">
            ...
            <div class="card fundraise-item">
              <a href="#"><img class="card-img-top" src="<?php bloginfo('template_url'); ?>/images/img_2.jpg" alt="Image placeholder"></a>
              <div class="card-body">
                <h3 class="card-title"><a href="#">Children Needs Food</a></h3>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <span class="donation-time mb-3 d-block">Last donation 1w ago</span>
            ...
            <div class="card fundraise-item">
              <a href="#"><img class="card-img-top" src="<?php bloginfo('template_url'); ?>/images/img_3.jpg" alt="Image placeholder"></a>
              <div class="card-body">
                <h3 class="card-title"><a href="#">Children Needs Food</a></h3>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <span class="donation-time mb-3 d-block">Last donation 1w ago</span>
            ...
            <div class="card fundraise-item">
              <a href="#"><img class="card-img-top" src="<?php bloginfo('template_url'); ?>/images/img_1.jpg" alt="Image placeholder"></a>
              <div class="card-body">
                <h3 class="card-title"><a href="#">Children Needs Food</a></h3>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <span class="donation-time mb-3 d-block">Last donation 1w ago</span>
  ...
  <div class="featured-section overlay-color-2" style="background-image: url('<?php bloginfo('template_url'); ?>/assets/images/bg_3.jpg');">
    
    <div class="container">
      <div class="row">

        <div class="col-md-6">
          <img src="<?php bloginfo('template_url'); ?>/assets/images/bg_3.jpg" alt="Image placeholder" class="img-fluid">
        </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="post-entry">
            <a href="#" class="mb-3 img-wrap">
              <img src="<?php bloginfo('template_url'); ?>/assets/images/img_4.jpg" alt="Image placeholder" class="img-fluid">
        ...
        <div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="post-entry">
            <a href="#" class="mb-3 img-wrap">
              <img src="<?php bloginfo('template_url'); ?>/assets/images/img_5.jpg" alt="Image placeholder" class="img-fluid">
              <span class="date">July 26, 2018</span>
            </a>
        ...
        <div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="post-entry">
            <a href="#" class="mb-3 img-wrap">
              <img src="<?php bloginfo('template_url'); ?>/assetsimages/img_6.jpg" alt="Image placeholder" class="img-fluid">
              <span class="date">July 26, 2018</span>
            </a>
